...
impl Config {
    ...
    pub fn compile_fds(&mut self, fds: FileDescriptorSet) -> Result<()> {
        ...
        let file_names = requests
            ...
            .collect::<IndexMap<Module, String>>();
    ...
    pub(crate) fn write_includes(
        ...
        file_names: &IndexMap<Module, String>,
    ) -> Result<()> {
        modules.sort();
    ...
    pub fn generate(
        ...
        for (request_module, request_fd) in requests {
            ...
            if buf.is_empty() {
                ...
                modules.shift_remove(&request_module);
            }
        }
    ...
    fn add_generated_modules(&mut self, modules: &mut IndexMap<Module, String>) {
        for buf in modules.values_mut() {
